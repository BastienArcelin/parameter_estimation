...
################# With generators
training_generator = generator.BatchGenerator_dc2(bands,
                                    images_dir,
                                    list_of_samples, 
...
validation_generator = generator.BatchGenerator_dc2(bands,
                                    images_dir,
                                    list_of_samples_val, 
                                    total_sample_size=None,
                                    batch_size=batch_size, 
...
test_generator = generator.BatchGenerator_dc2(bands, 
                                    images_dir,
